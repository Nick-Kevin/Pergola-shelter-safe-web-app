    ...
    return (
        <div>
            ...
            <section id="features" className="py-32">
                ...
                <div className="flex justify-around md:px-36 mt-20">
                    <div className="w-56 rounded-lg border border-[#06060630] shadow-xl p-8">
                    ...
                    <div className="w-56 rounded-lg border border-[#06060630] shadow-xl p-8">
                        <div className="flex justify-center">
                            <img src={camera} alt="camera" className="w-10" />
                        </div>
                        <p className="mt-5">Camera de surveillance</p>
                    </div>
                    <div className="w-56 rounded-lg border border-[#06060630] shadow-xl p-8">
                        <div className="flex justify-center">
